...
class InsumosVenta extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('insumos_venta', function (Blueprint $table) {
         $table->increments('id');
         $table->string('id_insumo',90);//
         $table->string('id_orden_venta',90);//
