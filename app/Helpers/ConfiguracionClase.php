...
'objeto',
'subojeto',//ademas de objeto, el subobjeto indica si debe buscar o tener parametro el documento o es un codigo muy especifico documento=> parametro de documento/otro=> codigo especifico a ejecutar para la verificar la condicxion
'clase',
'subclase',
'clasificacion',
'organizacion'
        ...
        return $this->hasMany('App\configuraciones_clase','id_foraneo','id');
    }
}
