...
.controller('contratoPdfCtrl_old',function ($scope,contratosSrc,$controller,$filter){
...
{text:"c)	INGENIEROS: ",bold:true},{text:'se entiende, al personal bajo la subordinación de SMH, asignado para cumplir con las obligaciones contraídas en este instrumento;\n\n'},
...
{text:'e)	MANTENIMIENTO PREVENTIVO: ',bold:true},{text:'se entiende, a todas las actividades realizadas por el ingeniero tendientes a realizar acciones de calibración, ajustes y limpieza del equipo y tiene por objeto la conservación del mismo, en condiciones normales de operación, de conformidad con los términos de referencia del fabricante, para prevenir fallas en su funcionamiento. Se recomendará realizar los cambios de ingeniería y las especificaciones técnicas que dicten los manuales, para mantener siempre actualizado el equipo, siempre que sean necesarios, incluyendo la revisión periódica de  seguridad  y control de funcionamiento,  ajustes, calibración y lubricación, limpieza  de partes inaccesibles para EL CLIENTE;\n\n'},
{text:'f)	CORRECTIVO: ',bold:true},{text:'se entiende, a todos los actos que realice el ingeniero a efecto de corregir las fallas del equipo que por su operación presente, para dejar el equipo en condiciones normales de funcionamiento de conformidad con los términos de referencia del fabricante.\n\nExpuesto lo anterior, exhiben los documentos con los cuales acreditan la personalidad que  ostentan y se reconocen mutuamente, conviniendo en celebrar el presente instrumento al tenor de las siguientes:\n'}];
$scope.acreditacion="Expuesto lo anterior, exhiben los documentos con los cuales acreditan la personalidad que  ostentan y se reconocen mutuamente, conviniendo en celebrar el presente instrumento al tenor de las siguientes:";
...
$scope.clausula_cuarta_tres="SMH se obliga a proporcionar el servicio correctivo en el plazo señalado en la fracción tercera de la cláusula séptima de este contrato en su horario hábil, que es de lunes a viernes de 9:00 a 19:00 hrs. exceptuando los siguientes días hábiles que son considerados como días festivos por la Ley Federal del Trabajo, igualmente quedarán exceptuados los días que señale como no laborables cualquier autoridad administrativa o judicial.\n\n";
...
$scope.clausula_septima_uno="\nI.	Las obligaciones de SMH están sujetas a la condición suspensiva de que el equipo se encuentre funcionando conforme a los estándares establecidos por el fabricante, y así deberá de corroborarlo el ingeniero asignado por SMH previo a la iniciación de la prestación de los servicios, haciéndolo constar en la orden de servicio que firmará el  CLIENTE. \n\nAsí mismo, SMH no se obliga a prestar el servicio y reparar el equipo en caso de que el daño se deba a mal uso del mismo, accidente, pérdida total del equipo, negligencia por parte del CLIENTE. Esta condición no faculta al CLIENTE a suspender el pago; pero SMH podrá cotizar su reparación con costo adicional a este contrato.";
$scope.clausula_septima_dos="\nII.	La periodicidad del mantenimiento preventivo será de acuerdo con el programa del Anexo 2;";
...
$scope.clausula_septima_cinco="\nV.	SMH se compromete a mantener el equipo en buen estado de funcionamiento programando dos mantenimientos preventivos al año. Para los servicios correctivos se dará atención con un tiempo de reparación máximo de 5 días hábiles contados a partir de la fecha de atención del reporte.\n\n"+
"Para los contratos denominados “SIN SUMINISTRO DE REFACCIONES”, la obligación se suspenderá por todo el tiempo que EL CLIENTE tarde en proporcionar las refacciones de la calidad requerida, aceptar la cotización que SMH presente por las refacciones o por la disponibilidad de las mismas con el proveedor, en este último caso SMH se compromete de manera conjunta con el proveedor a dar solución inmediata en un tiempo máximo de respuesta de 4 horas vía telefónica y 24 horas en sitio, fecha en la cual serán entregadas previa revisión del encargado del área designado por EL CLIENTE. En caso de que no exista respuesta favorable por parte de SMH en los términos pactados, EL CLIENTE podrá llevar a cabo y sin responsabilidad alguna negociación con cualquier tercero, respecto de la adquisición de dichas refacciones, sin que ello genere pago o sanción alguna a su cargo.";
$scope.clausula_septima_seis="\nVI.	SMH atenderá los servicios reportados por las unidades descritas en el anexo No 1 del  CLIENTE y  serán atendidos por el personal especializado en la rama técnica a la que pertenecen los diferentes equipos que integran el presente convenio a los teléfonos: 01 (55) 56-87-61-64, 56-87-61-75.";
$scope.clausula_septima_siete="\nVII.	Los ingenieros que acudan a realizar Mantenimiento Preventivo y/o Correctivos deberán reportarse al área responsable del CLIENTE a su llegada y una vez que hayan terminado el trabajo deberá ser firmada por AMBAS PARTES el acta de servicio por el personal facultado de cada parte";
$scope.clausula_septima_ocho="\nVIII.	Los ingenieros de servicio deberán presentarse con el CLIENTE con los materiales y herramientas necesarios para realizar los servicios de mantenimiento preventivo y correctivo contratados;";
$scope.clausula_septima_nueve="\nIX.	Los ingenieros de servicio deberán dejar copia e integrar la orden de trabajo en el área responsable para integrar la bitácora de comportamiento de la máquina y con ello tener un seguimiento del equipo. Al registrar en SMH copia de las mismas planillas tendremos el canal de comunicación que se necesita para tener información similar en ambas partes;";
$scope.clausula_septima_diez="\nX.	SMH se compromete a proporcionar las refacciones nuevas y originales, necesarias para el buen funcionamiento de los equipos materia de este convenio y que no estan consideradas en la propuesta; en terminos de lo dispuesto en la cláusula Quinta. ";
$scope.clausula_septima_once="\nXI.	XI.	Para los contratos denominados “CON SUMINISTRO DE REFACCIONES”, SMH se obliga a sustituir las partes y refacciones incluidas que no funcionen correctamente, previo dictamen técnico.\n\n"+
"Para los contratos denominados “SIN SUMINISTRO DE REFACCIONES” SMH se obliga a cotizar las partes y refacciones que no funcionen correctamente, sustituir las refacciones cotizadas y aceptadas por parte de EL CLIENTE; ";
$scope.clausula_septima_doce="\nXII.	SMH responderá por daños directos que le sean legalmente imputables, ocasionados por su personal siempre y cuando se encuentren actuando dentro de las actividades encomendadas por dicha empresa. Cualquier otro tipo de indemnización queda excluida.";
...
$scope.clausula_septima_catorce="\nXIV.	No será obligación de SMH el traslado total o parcial del equipo, desinstalación o reinstalación del equipo, total o parcial para su reubicación; en caso de requerirlo se cotizará y será objeto de diverso contrato. ";
$scope.clausula_octava_uno="\nI.	Además de la obligación contenida en la cláusula segunda, se obliga a dar acceso al equipo para su mantenimiento preventivo y correctivo únicamente al personal designado por SMH, en el caso que el CLIENTE diera acceso a los equipos para su mantenimiento a personal distinto al designado por SMH, este último podrá rescindir a su conveniencia el presente convenio sin ninguna responsabilidad;";
...
$scope.clausula_novena_uno="\nSMH se obliga a que los mantenimientos serán de acuerdo a lo mencionado en el contrato y anexos.  Dicha calidad deberá ser igual o superior a los estándares comerciales y/o industriales generalmente aceptados, para lo cual se compromete a Implantar las medidas preventivas de seguridad adecuadas para la realización de los mismos,  conducentes a minimizar los impactos a la integridad del paciente, visitantes, empleados e instalaciones de EL CLIENTE, para lo cual SMH dará formación e instrucciones específicas en materia de buenas prácticas al personal que vaya a prestar servicio a las instalaciones de EL CLIENTE. \n\n"+
"De igual forma EL CLIENTE se reserva el derecho de constatar que dichos mantenimientos se realicen bajo estándares comerciales y/o industriales generalmente aceptados, de tal manera que permita que tales bienes y/o servicios cumplan con los requisitos especificados en el presente contrato, pudiendo en consecuencia hacer las observaciones que estime pertinentes a SMH a fin de que este último realice las adecuaciones y /o ajustes necesarios a los mantenimientos, en caso contrario EL CLIENTE podrá llevar a cabo la rescisión del contrato, sin responsabilidad alguna, bastando únicamente el comunicado que en tal sentido le exprese a SMH.";
...
$scope.clausula_decima_cuarta="\nSMH, previo aviso por escrito a EL CLIENTE, podrá suspender la prestación del servicio, objeto del presente contrato, cuando EL CLIENTE, no haya cumplido con el pago en tiempo y forma las contraprestaciones señaladas en el presente contrato, no obstante SMH haber cubierto a cabalidad sus obligaciones a cargo. \n\n"+
...
$scope.clausula_decima_quinta_dos="\na)		Si EL CLIENTE no realiza puntualmente el pago de los honorarios a que tiene derecho SMH, haciendo exigibles dichos pagos al momento de la rescisión del contrato, a excepción de los presupuestos del presente contrato.\n\n"+
...
$scope.clausula_decima_quinta_tres="\na)	La falta de realización de la prestación de servicios profesionales objeto del presente contrato con la calidad,  tiempo y forma convenidos de acuerdo al calendario de mantenimientos.\n\n"+
...
$scope.clausula_vigesima="\nLAS PARTES manifiestan bajo protesta de decir verdad que durante las negociaciones y para la celebración del presente contrato se han abstenido de adoptar conductas de soborno y/o corrupción u otras conductas sancionadas por la ley, y así se conducirán en el cumplimiento de su objeto.";
...
pageOrientation: 'portrait',                  
    pageMargins: [ 40, 50, 40, 50 ],        
        ...
        content:[{ text: 'Nombre fiscal',fontSize:10,bold:true,alignment:'center',decoration:'underline'},//0
                 ...
                 { text: '\nCLAUSULAS',fontSize:10,bold:true,alignment:'center'},//9
                 ...
                 { //16
                  ...
                  { text: 'V',alignment: 'left',fontSize:10,alignment:'justify'},//18
                  { text: 'VI',alignment: 'left',fontSize:10,alignment:'justify'},//19
                  ...
                  { text: '\n\nNOVENA: 	            DE LA CALIDAD.',fontSize:10,bold:true }, //52
                 ...
                 {//93
                  ...
                  table: {
                          widths: ['*','*','*','*'], 
                          body: [   
									[{text:'NUM',alignment:'center',fillColor: 'gray'},{text:'ÉQUIPO',alignment:'center',fillColor: 'gray'},{text:'MODELO',alignment:'center',fillColor: 'gray'},{text:'SERIE',alignment:'center',fillColor: 'gray'}],
                                ]
                        },
                         //layout: 'noBorders'
                  },
                  ...
                  table: {
                          widths: ['*','*','*','*'], 
                          body: [   
									[{text:'NUM',alignment:'center',fillColor: 'white'},{text:'ÉQUIPO',alignment:'center',fillColor: 'white'},{text:'MODELO',alignment:'center',fillColor: 'white'},{text:'SERIE',alignment:'center',fillColor: 'white'}],
									[{text:"\nSUCURSAL",alignment:'center',colSpan:4,decoration:'underline'},{},{},{}],
                  ...
                  table: {
                          widths: ['*','*','*','*'], 
                          body: [   
									[{text:'UBICACION',alignment:'center',fillColor: 'gray'},{text:'EQUIPO',alignment:'center',fillColor: 'gray'},{text:'FECHA',alignment:'center',fillColor: 'gray'},{text:'HORARIO',alignment:'center',fillColor: 'gray'}],
                                ]
                        },
                         //layout: 'noBorders'
                  },
...
//  	$scope.declaracion_smh="\na)	Es una persona moral debidamente constituida conforme a las leyes de los Estados Unidos Mexicanos, situación que se acredita con el testimonio de la escritura numero 52,038, de fecha 10 de Marzo de 1989, otorgada ante la fe del Notario Público, licenciado Francisco de P. Morales Díaz, titular de la Notaría 60 sesenta con ejercicio en el Distrito Federal.\n\nb)	Su representante, el "+d.objeto.contrato.representante_smh+" con el carácter de Apoderado legal cuenta con las facultades suficientes para obligarla en términos del presente convenio, situación que acredita en términos del testimonio de la escritura pública No 94,773 de fecha 24 de Octubre del 2014, otorgada ante la fe del Notario Público No. 60, 22 y 217, Lic. Francisco de P. Morales Díaz, Lic. Luis Felipe Morales Viesca y Lic. José Ángel Fernández Uría, Notarias Asociadas, de esta Ciudad de México, Distrito Federal, manifestando además, bajo protesta de decir verdad que dicho poder no le ha sido revocado ni modificado.  \n\nc)	Para los efectos del presente convenio señala como su domicilio Fiscal: DIAGONAL # 27 COL. DEL VALLE DELEGACIÓN BENITO JUAREZ, C. P. 03100 EN LA CIUDAD DE MEXICO, D. F. \n\nd)	Que cuenta con el Registro Federal de Causantes: SUM-890327-137";
  	$scope.clausula_primera="\nPor el pago a que se refiere la cláusula próxima siguiente SMH se compromete a realizar el servicio de "+d.objeto.contrato.tipo_contrato+" para el equipo señalado por el CLIENTE en el inciso c), de sus declaraciones. Los servicios de MANTENIMIENTO PREVENTIVO Y CORRECTIVO materia de este contrato se harán dé acuerdo con las prácticas y estándares establecidos para tal efecto y que consiste, según se describe  en Anexo 1 que firmado por las partes forma parte integral de este contrato. SMH se obliga a prestar servicios de MANTENIMIENTO PREVENTIVO Y CORRECTIVO, sin que el costo de este contrato incluya "+d.objeto.contrato.refacciones_excepciones;
  	...
  	if(d.objeto.contrato.modalidad_pagos=='1'){
  		$scope.modalidad='MES';
  	}else{
  	...
  	$scope.clausula_segunda_cuatro="IV.	La falta del pago oportuno de alguno de los pagos pactados a que se refiere la fracción anterior, en su fecha de vencimiento, facultará a SMH para dar por vencido anticipadamente el plazo para el pago de la totalidad del saldo insoluto de este convenio, incluyendo el importe de todos los abonos restantes y desde entonces, se causarán intereses moratorios a la tasa del "+d.objeto.contrato.interes_moratorio_cliente+"% ("+$scope.letras_interes+" Por ciento) mensual sobre la cantidad principal, hasta la fecha en que se efectúe el pago total del adeudo. \n\n";
  	$scope.letras_descuento=$scope.NumeroALetras(d.objeto.contrato.descuento_incumplimiento_smh,"");
	$scope.clausula_segunda_cinco="V.	El incumplimiento a lo establecido en la fracción tercera de la cláusula séptima facultará al  CLIENTE para que retenga por concepto de descuento la cantidad que corresponda al "+d.objeto.contrato.descuento_incumplimiento_smh+"% (Cero, Punto Veinticinco Porciento) diario, por todo el tiempo que transcurra sin que SMH atienda el reporte, hasta por la cantidad que corresponda en pago a SMH y se cuantificará sobre la cantidad a pagar de cualquiera de los dos pagos a que hace referencia la fracción tercera de esta cláusula, este descuento será procedente a partir del siguiente día hábil después de transcurrido el término de 48 horas concedido a SMH para atender el reporte.\n\n";
	...
	//$scope.clausula_tercera_lugar_pago=d.objeto.contrato.lugar_pago_cliente+". También queda facultado el CLIENTE para pagar en moneda nacional a la cuenta 525245, sucursal 870 con referencia 7998-85, cuenta correspondiente a la Institución de Crédito denominada Banco Nacional de México, S.A. (Banamex). En todos los casos los depósitos se harán a nombre de Suministro para Uso Médico y Hospitalario, S.A. de C.V.";
  	$scope.letras_ubicacion=$scope.NumeroALetras(d.objeto.contrato.monto_nueva_ubicacion,d.objeto.contrato.moneda);
	...
	var folio1=$scope.pad(folio[0]);
  	...
  	//contratoSmh.header.table.body[0][3]="CT-"+folio1+"-"+folio[1];
  	//contratoSmh.header.table.body[0][3]=d.objeto.folio_contrato;
  	contratoSmh.content[0].text='"'+d.objeto.nombre_fiscal+'"';
  	...
  	//contratoSmh.content[6].text=$scope.declaracion_smh+"\n";
  	contratoSmh.content[8].text=$scope.definiciones;
  //	contratoSmh.content[8].text=$scope.acreditacion+"\n";
  	...
  	contratoSmh.content[15].text=$scope.clausula_segunda_tres;
	var i=2;
	var j=1;
	var modalidad=d.objeto.contrato.modalidad_pagos;
...
var fecha=30;
$scope.fecha_modalidad=30.5*modalidad;

/*	var fecha2=new Date(); 										console.log(fecha2);
	//var fecha3=new Date(pi1[0],pi1[1],pi2); 					console.log(fecha3);console.log(pi1[0]+"-"+pi1[1]+"-"+pi2);
	var fecha3=new Date(pi1[0],pi4,pi2); 					//console.log(fecha3);console.log(pi1[0]+"-"+pi1[1]+"-"+pi2);

	if(fecha2<fecha3){
		console.log(fecha2+' < '+fecha3);var fecha=60;
	}else{
		console.log(fecha2+' > '+fecha3);var fecha=30;
	}
	if(fecha2.getDate()==1 || fecha2.getDate()==2 || fecha2.getDate()==3){
		//alert("mas 1");
	$scope.fecha_modalidad=31*modalidad;
	*//*}else if(fecha2.getDate()>2){
		$scope.fecha_modalidad=30*modalidad;*/
	/*} 	else{
	$scope.fecha_modalidad=30*modalidad;
}*/
 		//
 	contratoSmh.content[16].table.body[0]= [{text:j+"/"+num_pagos,alignment:'center'},{text:$scope.fecha_pago_inicial,alignment:'center'}];
	while(j<num_pagos){
 		fecha_pago=$scope.sumaFechas(fecha,' - ',pi1[0],pi4,d.objeto.contrato.dia_final_pago);
 		//fecha_pago=$scope.sumaFecha(fecha,' - ');
 		contratoSmh.content[16].table.body[j]= [{text:i+"/"+num_pagos ,alignment:'center'},{text:d.objeto.contrato.dia_final_pago+fecha_pago,alignment:'center'}],
// 		contratoSmh.content[16].table.body[j]= [{text:i+"/"+num_pagos ,alignment:'center'},{text:pi2+fecha_pago,alignment:'center'}],UPDATE 01-02-2017
 		//console.log(fecha);
 		console.log(j);
	...
	contratoSmh.content[16].table.body[j]=[{text:".",alignment:'center'},{text:".",alignment:'center'}];//console.log(fecha);
...
//$scope.equipos_f = $scope.arrUnique(d.objeto.r_conts_eqps); //console.log($scope.equipos_f);//console.log($scope.equipos_f.equipo);//console.log($scope.equipos_f[0].equipo);
  	...
  	contratoSmh.content[97].table.body[2]= [{text:d.objeto.r_conts_eqps[i].calle+"\n"+d.objeto.r_conts_eqps[i].colonia+"\n"+d.objeto.r_conts_eqps[i].c_p+"\n"+d.objeto.r_conts_eqps[i].ciudad+"\n"+d.objeto.r_conts_eqps[i].estado,alignment:'center',colSpan:4,bold:true},{},{},{}];
  	...
  	while(i<d.objeto.r_conts_eqps.length){
	  	contratoSmh.content[101].table.body[j]= [	
	  												...
	  												{text:d.objeto.r_conts_eqps[i].fecha_inicio+" "+d.objeto.r_conts_eqps[i].fecha_fin,alignment:'center'},
