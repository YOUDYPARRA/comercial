<div class="row">
    ...
    <div class='col-md-6'>  
        <div class="form-group has-info" >
            <label class="control-label"><i class="material-icons"></i>Seleccione contrato:</label>
            {!! Form::select('numero_contrato_compra_venta',NumerosContratoCompraVenta::listContrato(), '',['class'=>'form-control'])!!}
        </div>
    </div>
</div>
