    ...
    <div class='col-md-3'>  
        ...
        <div class='col-md-3'>  
            ...
            <label class="control-label"><i class="material-icons">attach_money</i>Precio</label>
                      {!! Form::text('precio','',array('class'=>'form-control','ng-model'=>'precioCompra','placeholder'=>'PRECIO')) !!}
        ...
        <div class='col-md-2'>  
          <div class="form-group has-info">
            ...
            <select name="repeaSelect" id="repeaSelect" ng-model="tipo" class="form-control" ng-change="montoSeleccionado(tipo);"  style="width: 120px;" ng-disabled="habilitarPrecio">
        ...
        <div class='col-md-1'>  
            <div class="form-group has-info">
              <label class="control-label"></label>
              <button class="btn btn-warning btn-fab" for="todoText" type="button" ng-click="agregarCarrito();" value="add" ng-disabled="habilitarBoton"><i class="material-icons">add_shopping_cart</i></button>
            </div>
        </div>
