    ...
    <div class="panel-group">
      <div class="panel panel-info">
        ...
        <div id="collapse2" class="panel-collapse collapse">
          ...
          <div class="col-md-2">
              <div class="form-group has-info">
                      {!! Form::text('folio',null,['class'=>'form-control','placeholder'=>'No. Orden'])!!}
              </div>
          </div>
          <div class="col-md-2">
              <div class="form-group has-info">
          ...
          <div class="col-md-2">
              <div class="form-group has-info">
                      {!! Form::text('no_contrato',null,['class'=>'form-control','placeholder'=>'Contrato'])!!}
              </div>
          </div>
          <div class="col-md-2">
              <div class="form-group has-info">
                      {!! Form::text('nombre_fiscal',null,['class'=>'form-control','placeholder'=>'Nombre fiscal'])!!}
                      {!! Form::hidden('buscar',1,['class'=>'form-control'])!!}
              </div>
          </div>
          <div class="col-md-2">
