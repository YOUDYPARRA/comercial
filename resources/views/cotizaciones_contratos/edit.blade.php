...
<div class="container" ng-controller="cotizacionContratoCtrl">
    <div class="row" ng-mouseover="activ=true" ng-init="activ=false;activar=true;id='{{$id}}'">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-info">
            <div class='panel-heading'><i class='material-icons'>edit</i> EDITAR COTIZACION CONTRATO:  <span class="badge badge-warning"><%objeto.dato%></span> VERSION: <span class="badge badge-warning"><%objeto.version%></span></div>
            ...
            <div class='panel-footer'> 
                <button type="button" ng-click='actualizar()' class="btn btn-raised btn-info btn-lg" title="GUARDAR" ng-disabled="save"><i class="material-icons">save</i></button>
                <span><%rsl.msg%></span>
                <span><%activg%></span>
            </div>
        </div>
