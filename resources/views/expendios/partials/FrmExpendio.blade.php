  ...
  <div class="panel-heading"><i class="material-icons">note_add</i> DATOS EQUIPO <span class="badge" ng-show="msg">Cargando ...</span></div>
    ...
    <div class="row">
        ...
        <div class='col-md-3'>        
            ...
            {!! Form::text('serie',null,array('ng-model'=>'objeto.numero_serie','class'=>'form-control','placeholder'=>'serie' )) !!}
            <label class='control-label'><i class='material-icons'>edit</i>OTRO SERIE</label>
