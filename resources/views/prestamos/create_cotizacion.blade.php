...
<div class="container">
	<div class="row">
      ...
      <div class="panel-heading"><i class="material-icons">note_add</i> CREAR COTIZACIÓN DESDE PRESTAMOS: <%numero_cotizacion%> <%cotizacion.equipo%><span ng-show="progress" class="badge badge-warning"> Cargando ...{{$objeto}}</span></div>
      ...
      <div class="panel-body" >
        ...
        <div class="panel panel-default">	
            ...
            <ul id="nav-tabs-wrapper" class="nav nav-tabs nav-tabs-horizontal navbar-custom">
              ...
              <li style="background-color: #999999"><a href="#htab3" data-toggle="tab"><i class="material-icons">print</i> BUSCAR PRODUCTO <span class="badge badge-warning"><%insumosB.length%></span></a></li>
            </ul>
