...
<div class="container">
	<div class="row">
      ...
      <div class="panel panel-info" ng-controller="CotizacionCtrl"> 
      <div class="panel-heading"><i class="material-icons">note_add</i> CREAR COTIZACIÓN<span ng-show="progress" class="badge badge-warning"> Cargando ...</span></div>
