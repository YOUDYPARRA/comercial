  ...
  <div class='col-md-3'>  
    ...
    <div class='col-md-3'>  
        <div class="form-group label-floating has-info">
			...
			<div class="row">
        <div class="col-sm-12">            
            <div style="height: 500px; overflow: scroll"><!-- scroll-glue-top> -->
    ...
    <div class='col-md-3'>  
        ...
        <div class='col-md-3'>  
            ...
            <label class="control-label"><i class="material-icons">attach_money</i>Precio</label>
                      {!! Form::text('precio','',array('class'=>'form-control','ng-model'=>'precio','placeholder'=>'PRECIO')) !!}
        ...
        <div class='col-md-2'>  
            <div class="form-group has-info">
              <label class="control-label"></label>
              <button class="btn btn-warning btn-fab" for="todoText" type="button" ng-click="agregarCarrito();"><i class="material-icons">add_shopping_cart</i></button>
            </div>
        </div>
