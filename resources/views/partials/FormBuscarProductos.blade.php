                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <span class="media-meta pull-right"><small><%grupo.categoria1%></small></span>  <!-- <% insumo.bandera_insumo%> -->
                                  <h4 class="title">
                                    <span class="pull-right pendiente"><%grupo.dato%><%grupo.folio%></span> <!-- <% insumo.codigo_proovedor %> -->
                                  </h4>
        ...
        <div class='col-md-1'>  
          <div class="form-group has-info">
            <label class="control-label">Precio</label>
                      {!! Form::text('precio','',array('class'=>'form-control','ng-model'=>'precioVenta','placeholder'=>'Precio','ng-show'=>'ver_precios_servicio','ng-disabled'=>'disabled_comprar')) !!}    
          </div>
        </div>
        <div class='col-md-2'>  
       <div class="form-group has-info">
        <label class="control-label">Moneda</label>
                  {!! Form::select('costo_moneda',array(''=>'Elige tipo moneda','USD'=>'USD','MXN'=>'MXN'),'',array('class'=>'form-control','ng-model'=>'moneda_destino','ng-show'=>'ver_precios_servicio','ng-disabled'=>'disabled_comprar')) !!}
      </div>
    </div>
        <div class='col-md-1'>  
            <div class="form-group has-info">
