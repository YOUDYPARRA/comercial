    ...
    <div class="row">
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select name="usuario1" ng-model="objeto.persona[0]" class="form-control" required="">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios | orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                </select>
            </div>
        </div>
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select  ng-model="objeto.persona[1]" class="form-control">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios| orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" value="<%user.id%>"><%user.name%></option>
                </select>
            </div>
        </div>
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select  ng-model="objeto.persona[2]" class="form-control">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios| orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" value="<%user.id%>"><%user.name%></option>
                </select>
        ...
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select  ng-model="objeto.persona[3]" class="form-control">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios| orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" value="<%user.id%>"><%user.name%></option>
                </select>
        ...
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select  ng-model="objeto.persona[4]" class="form-control">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios| orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" value="<%user.id%>"><%user.name%></option>
                </select>
        ...
        <div class='col-md-3'>        
            <div class="form-group has-info">
                ...
                <select  ng-model="objeto.persona[5]" class="form-control">
                     <option value="">Elegir. . .</option>
                     <option ng-if="crear" ng-repeat="user in usuarios| orderBy : 'name'" ng-if="user.puesto == 'COORDINADOR DE SERVICIOS' || user.puesto == 'INGENIERO DE SERVICIOS'" value="<%user.id%>"><%user.name%></option>
                     <option ng-if="update" ng-repeat="user in usuarios | number:0" value="<%user.id%>"><%user.name%></option>
                </select>
