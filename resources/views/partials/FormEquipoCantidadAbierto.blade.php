<div class="panel panel-info">
  <div class="panel-heading"><i class="material-icons">note_add</i> DATOS EQUIPO <span class="badge" ng-show="msg">Cargando ...</span></div>
    ...
    <fieldset ng-disabled="esc_datosEquipo"></fieldset>
    <div class="row">
        <div class='col-md-2'>
            <div class="form-group has-info">
                <label class='control-label'><i class='material-icons'>edit</i>CANTIDAD </label>
                {!! Form::text('cantidad',null,array('ng-model'=>'objeto.cantidad','class'=>'form-control','placeholder'=>'CANTIDAD')) !!}
            </div>
        </div>
        <div class='col-md-2'>
            <div class="form-group has-info">
                <label class='control-label'><i class='material-icons'>edit</i>CODIGO PROVEEDOR </label>
                {!! Form::text('codigo_proovedor',null,array('ng-model'=>'objeto.codigo_proovedor','class'=>'form-control','placeholder'=>'CODIGO ')) !!}
            </div>
        </div>
        <!--
        <div class='col-md-2'>
      ...
      -->
        ...
        <div class="form-group has-info">
            ...
            {!! Form::text('marca',null,array('ng-model'=>'objeto.marca','class'=>'form-control','placeholder'=>'MARCA')) !!}
        </div>
        </div>
        <div class='col-md-2'>
            <div class="form-group has-info">
            ...
            {!! Form::text('modelo',null,array('ng-model'=>'objeto.modelo','class'=>'form-control','placeholder'=>'MODELO')) !!}
            </div>
        </div>
        <div class='col-md-2'>
            <div class="form-group has-info">
            ...
            {!! Form::text('descripcion',null,array('ng-model'=>'objeto.descripcion','class'=>'form-control','placeholder'=>'descripcion','ng-change'=>'getContrato()')) !!}
            </div>
        </div>
    </div>
    <div class="row">
