        ...
        <div id="collapse2" class="panel-collapse collapse">
          ...
          <div class="col-md-2">
              <div class="form-group has-info">
                  ...
                  <div class="form-group">
                      {!! Form::text('proyecto',null,['class'=>'form-group','placeholder'=>'PROYECTO'])!!}
                  </div>
              </div>
          </div>
          <div class="col-md-2">
              <div class="form-group has-info">
                  ...
                  <div class="form-group">
                      {!! Form::text('entrega',null,['class'=>'form-group','placeholder'=>'ENTREGA'])!!}
                  </div>
              </div>
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-2">
              <div class="form-group has-info">
                  ...
                  <div class="form-group">
                      {!! Form::text('prioridad',null,['class'=>'form-group','placeholder'=>'PRIORIDAD'])!!}
